    ...
    public Message processAndReply(Message inMessage) throws MessageException
    {
        ...
        switch (inMessage.getType())
        {
            case Message.ADD_CANVAS:
                agr.addCrookCanvas(inMessage.getElemId());
